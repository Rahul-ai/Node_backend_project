...
async function _getClientVersion(config) {
  ...
  if (suffix === "integration" || (suffix == null ? void 0 : suffix.startsWith("dev")) || clientVersion === "0.0.0") {
    ...
    const res = await (0, import_request.request)(`${prismaNpm}/${published}`, { clientVersion });
